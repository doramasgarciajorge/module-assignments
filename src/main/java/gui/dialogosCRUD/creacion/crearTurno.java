...
public class crearTurno extends javax.swing.JDialog {

    /**
     * Creates new form crearTurno
     */
    public crearTurno(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        botonCrear.setText("Crear turno");
    ...
    private void botonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCrearActionPerformed
        if (campoDescripcion.getText().isBlank()){
            ...
            try {
                crud.TurnosCRUD.crear(new objetos.Turno(campoDescripcion.getText()));
                dispose();
                logica.LogicaTablas.actualizarTablasBaseDeDatos();
            } catch (SQLException ex) {
                Logger.getLogger(crearTurno.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                crearTurno dialog = new crearTurno(new javax.swing.JFrame(), true);
