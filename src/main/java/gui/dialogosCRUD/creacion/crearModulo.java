...
public class crearModulo extends javax.swing.JDialog {
     ...
     */
    public crearModulo(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
        
        spinnerHorasReales.setValue(5);
        spinnerHorasPonderadas.setValue(4);
    ...
    private void initComponents() {
        ...
        botonCrear.setText("Crear módulo");
    ...
    private void botonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCrearActionPerformed
        if (campoCodigo.getText().isBlank() || campoDescripcion.getText().isBlank()){
            ...
            try {
                crud.ModulosCRUD.crear(new objetos.Modulo(campoCodigo.getText(), campoDescripcion.getText(), Integer.parseInt(spinnerHorasReales.getValue().toString()), Integer.parseInt(spinnerHorasPonderadas.getValue().toString()), Integer.parseInt(comboEspecialidad.getSelectedItem().toString().substring(0, comboEspecialidad.getSelectedItem().toString().indexOf(".")))));
                dispose();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(crearModulo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
