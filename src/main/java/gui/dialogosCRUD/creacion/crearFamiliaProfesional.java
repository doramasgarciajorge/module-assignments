...
public class crearFamiliaProfesional extends javax.swing.JDialog {

    /**
     * Creates new form crearTurno
     */
    public crearFamiliaProfesional(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Creación de familias profesionales");
        setResizable(false);
        ...
        botonCrear.setText("Crear familia profesional");
    ...
    private void botonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCrearActionPerformed
        if (campoDescripcion.getText().isBlank()){
            ...
            try {
                crud.FamiliasProfesionalesCRUD.crear(new objetos.FamiliaProfesional(campoDescripcion.getText()));
                dispose();
                logica.LogicaTablas.actualizarTablasBaseDeDatos();
            } catch (SQLException ex) {
                Logger.getLogger(crearFamiliaProfesional.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crearFamiliaProfesional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                crearFamiliaProfesional dialog = new crearFamiliaProfesional(new javax.swing.JFrame(), true);
